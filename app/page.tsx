        ...
        <div className="site-container grid min-h-162.5 items-center gap-10 py-16 lg:grid-cols-[1.05fr_.95fr] lg:py-20">
          <Reveal className="relative z-10">
            ...
            <p className="mt-7 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg sm:leading-9">
              برای انتخاب بیمه مناسب خود، خانواده یا کسب‌وکارتان، اطلاعات را
              ساده و روشن بررسی کنید و برای دریافت مشاوره با نمایندگی آفرین
              صناعی در ارتباط باشید.
            </p>
        ...
        <div className="rounded-[2.2rem] bg-slate-950 px-7 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10 lg:px-12">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-8 text-slate-300">
              درخواست خود را ثبت کنید تا بعد از تکمیل اطلاعات تماس واقعی
              نمایندگی، مسیر مشاوره مستقیماً از همین سایت قابل استفاده باشد.
            </p>
          </div>
          <Link
            href="/contact"
